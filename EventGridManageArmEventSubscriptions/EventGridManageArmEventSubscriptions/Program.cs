...
namespace EventGridManageArmEventSubscriptions
{
    /// <summary>
    /// Azure EventGrid Management Sample - Demonstrate how to create and manage EventGrid event subscriptions to an Azure subscription
    /// or ResourceGroup using EventGrid Management SDK. This sample will also demonstrate using a storage queue as the destination of
